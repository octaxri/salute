...
.factory('taToolFunctions', ['$window','taTranslations', function($window, taTranslations) {
    return {
        imgOnSelectAction: function(event, $element, editorScope){
            ...
            var floatLeft = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1"><i class="icon icon-align-left"></i></button>');
            ...
            var floatRight = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1"><i class="icon icon-align-right"></i></button>');
            ...
            var floatNone = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1"><i class="icon icon-align-justify"></i></button>');
            ...
            var remove = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" unselectable="on" tabindex="-1"><i class="icon icon-trash-o"></i></button>');
        ...
        aOnSelectAction: function(event, $element, editorScope){
            ...
            var reLinkButton = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" tabindex="-1" unselectable="on" title="' + taTranslations.editLink.reLinkButton.tooltip + '"><i class="icon icon-edit icon-edit"></i></button>');
            ...
            var unLinkButton = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" tabindex="-1" unselectable="on" title="' + taTranslations.editLink.unLinkButton.tooltip + '"><i class="icon icon-unlink icon-unlink"></i></button>');
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', '$log',
    ...
    taRegisterTool('quote', {
        iconclass: 'icon icon-quote-right',
    ...
    taRegisterTool('justifyLeft', {
        iconclass: 'icon icon-align-left',
    ...
    taRegisterTool('justifyRight', {
        iconclass: 'icon icon-align-right',
    ...
    taRegisterTool('justifyFull', {
        iconclass: 'icon icon-align-justify',
    ...
    taRegisterTool('justifyCenter', {
        iconclass: 'icon icon-align-center',
    ...
    taRegisterTool('strikeThrough', {
        iconclass: 'icon icon-strikethrough',
    ...
    taRegisterTool('insertVideo', {
        iconclass: 'icon icon-youtube-play',
