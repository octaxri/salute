...
class Laporan extends CI_Controller {
    ...
    function rekap_kelas_unit_kompetensi($kd_pelatihan)
    {
		...
		$this->load->view('v_laporan/pdf/kuisioner_b_unit_kompetensi',$data);
    }
    ...
    function rekap_kejuruan_kuisioner_c_sarpras($kejuruan){
		...
		$this->load->view('v_laporan/pdf/rekap_kejuruan_kuisioner_c_sarpras',$data);
	}
	...
	function cetak_kejuruan_kuisioner_c_konsumsi($kejuruan)
	{
        ...
        $data['uraian'] = $this->db->query("SELECT * FROM kuisioner_c WHERE jenis_soal=4 AND tipe_soal='uraian'")->result_array();
	...
	function cetak_kejuruan_kuisioner_c_umum($kejuruan)
	{
        ...
        $data['uraian'] = $this->db->query("SELECT * FROM kuisioner_c WHERE jenis_soal=7 AND tipe_soal='uraian'")->result_array();
    ...
    function cetak_tahap_hasil_analisa_angket($tahap){
        $data['tahap']=$tahap;
		...
		$this->load->view('v_laporan/pdf/rekap_tahap_hasil_analisa_angket',$data);
    }
 ...
 function rekap_kelas_excel_hasil_analis_angket($kd_pelatihan)
 {
    ...
    function rekap_kelas_excel_unit_kompetensi($kd_pelatihan)
    {
		$data['title'] = "Kuisioner B | Unit Kompetensi";
		...
		$this->load->view('v_laporan/excel/kuisioner_b_unit_kompetensi',$data);
    }
   ...
   $data['soal_uraian'] = $this->db->query("SELECT * FROM kuisioner_c WHERE jenis_soal=2 AND tipe_soal='uraian'")->result_array();
    ...
    function export_kejuruan_excel_kuisioner_c_sapras($kejuruan)
	{
		$data['title'] = "Kuisioner C - Sarana / Prasarana | Kejuruan : .$kejuruan.";
		$data['pelatihan']= $this->db->query("SELECT * FROM pelatihan WHERE id_kejuruan=$kejuruan ")->result_array();
        $data['kejuruan1']=$this->M_kejuruan->tampil_detail_kejuruan($kejuruan);
		$data['kejuruan']= $kejuruan;
		...
		$this->load->view('v_laporan/excel/rekap_kejuruan_kuisioner_c_sapras',$data);
	}
    ...
    function rekap_tahap_excel_hasil_analisa_angket($tahap){

		$data['title'] = "Kuisioner B - Hasil Rekap Analisa Angket | Tahap : .$tahap.";
		$data['tahap']=$tahap;
		...
		$this->load->view('v_laporan/excel/rekap_tahap_hasil_analisa_angket',$data);
    }

    function export_exel_pertahap_kuisioner_b_tenaga_pelatih($tahap,$id_pengajar){
        $data['title'] = "Kuisioner B - Tenaga Pelatih | Tahap : .$tahap.";
		$data['pelatihan'] = $this->db->query("SELECT * FROM pelatihan WHERE tahap_pelatihan='$tahap'")->result_array();
        $data['tahap'] = $tahap;
        $data['id_pengajar'] = $id_pengajar;
        $data['pengajar'] = $this->db->query("SELECT * FROM pengajar WHERE id_pengajar='$id_pengajar'")->row_array();
		...
		$this->load->view('v_laporan/excel/rekap_tahap_kuisioner_b_tenaga_pelatih',$data);
    }
