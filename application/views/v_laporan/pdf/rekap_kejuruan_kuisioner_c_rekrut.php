            ...
            <tr>
                <td colspan="3">
                        ...
                        <tr>
                          ...
                          <th colspan="<?= $jml_kuisioner_c_rekruitmen;?>" align="center">Rekruitmen, Perjalanan, Persyaratan Peserta</th>
                      ...
                      <?php $i1=1;  foreach($pelatihan as $pl){ ?>
                       ...
                       <tr align="center">
                        ...
                        <tr>
                          <td>Jumlah</td>
                          <td colspan="<?= $jml_kuisioner_c_rekruitmen;?>" align="center"><h4><?= number_format($jmlh_keseluruhan,2) ;?></h4></td>
                        </tr>

                        <tr>
                          <td>Jumlah X 25</td>
                          <td colspan="<?= $jml_kuisioner_c_rekruitmen; ?>" align="center"><h4><?= $hasil_akhir = number_format($jmlh_keseluruhan*25,2);?> 
                          <?php 
