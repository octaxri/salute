...
<body onload="window.print()">
    <table align="center" cellspacing="10" style="margin-right:0px; margin-bottom:0px;">
            <tr>
                <td colspan="3"><center><h4>LAPORAN PER PROGRAM : <?= $program1['nama_program']; ?></h4></center><center><h4>PENGELOHAN INDEKS KEPUASAN MASYARAKAT PER RESPONDEN DAN PER UNSUR PELAYANAN</h4></center></td>
            </tr>
            <tr>
