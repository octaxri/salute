...
<table align="center" cellspacing="5">
            ...
            <tr>
                ...
                PER PROGRAM : <?= $program1['nama_program']; ?>
                </h4></center></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                        ...
                        <tr align="center">
                          ...
                          <th colspan="<?= $jml_kuisioner_c_rekrut;?>" align="center">Rekruitmen, Perjalanan, Persyaratan Peserta</th>
                        </tr>
                        ...
                        <tr align="center">
                          ...
                          <?php  $jmlh_keseluruhan = 0; foreach($kuisioner_c_rekrut as $sl){ 
                              ...
                              $total = $this->db->query("SELECT AVG(jawaban) as total FROM penilaian_c LEFT JOIN pelatihan ON penilaian_c.kd_pelatihan=pelatihan.kd_pelatihan 
                                                            WHERE penilaian_c.id_soalC='$id_soalnya' AND pelatihan.id_program='$program'")->row_array();
                          ?>
                            <td align="center"><?= number_format($total['total']/$jml_kuisioner_c_rekrut,2); ?></td>
                          <?php $jmlh_keseluruhan = $jmlh_keseluruhan+(number_format($total['total']/$jml_kuisioner_c_rekrut,2)); } ?>
                        
                        </tr>
                        <tr align="center">
                          <td>Jumlah</td>
                          <td colspan="<?= $jml_kuisioner_c_rekrut;?>" align="center"><h4><?= number_format($jmlh_keseluruhan,2) ;?></h4></td>
                        </tr>
                        <tr align="center">
                          <td>Jumlah X 25</td>
                          <td colspan="<?= $jml_kuisioner_c_rekrut;?>" align="center"><h4><?= $hasil_akhir= number_format($jmlh_keseluruhan*25,2) ;?>
