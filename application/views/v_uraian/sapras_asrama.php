        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">DATA KOMENTAR / SARAN  SARANA DAN PRASARANA ASRAMA</span>
            </h1>
          </div>
          <hr>
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <strong>Daftar Komentar Sarana dan Prasarana Asrama</strong>
                </div>
                <div class="card-body">
