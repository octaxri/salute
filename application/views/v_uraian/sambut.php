        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib">DATA KOMENTAR / SARAN PENYAMBUTAN, PEMBAGIAN KAMAR PESERTA</span>
            </h1>
          </div>
          <hr>
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <strong>Daftar Komentar Penyambutan, Pembagian Kamar Peserta</strong>
                </div>
                <div class="card-body">
