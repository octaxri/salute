        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib"><a class="btn btn-info" href="<?= base_url(); ?>rekap_program/rekap_kuisioner/2/<?= $program; ?>" ><span class="icon icon-backward"></span></a> LAPORAN KUISIONER B - TENAGA PELATIH | PER PROGRAM : <?= $program1['nama_program']; ?></span>
            </h1>
          </div>
          <hr>
          <br>
            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/cetak_program_kuisioner_b_tenaga_pelatih/<?= $program; ?>/<?= $id_pengajar; ?>" target="_blank" class="btn btn-danger icon icon-file-pdf-o"> PDF</a> | <a href="<?= base_url(); ?>laporan/export_excel_program_kuisioner_b_tenaga_pelatih/<?= $program; ?>/<?=$id_pengajar;?>" class="btn btn-success icon icon-file-excel-o"> Excel</a>
                    </center>
                    <br><br>
                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        ?>
                          ...
                          ?>  
                            <td align="center"><?= $nilainya2['jawaban']; ?></td>
                          <?php } ?>
                          ...
                          ?>  
                            <td align="center"><?= $nilainya3['jawaban']; ?></td>
                          <?php } ?>
                          ...
                          <td align="center"><?= $nilainya4['id_user']; ?></td>
                          </tr>
                        <?php } ?>
                          ...
                          <?php 
                            foreach($kemampuan as $s2){
                              ...
                              $total2 = $this->db->query("SELECT SUM(jawaban) as total FROM penilaian_b LEFT JOIN pelatihan ON penilaian_b.kd_pelatihan=pelatihan.kd_pelatihan
                                                                LEFT JOIN kuisioner_b ON penilaian_b.id_soalB=kuisioner_b.id_kuisionerB
                                                                LEFT JOIN detail_penilaian_b ON detail_penilaian_b.id_penilaian_b=penilaian_b.idku
                                                                WHERE penilaian_b.id_soalB='$id_soal2' AND pelatihan.id_program='$program' AND kuisioner_b.jenis_soal=2 AND kuisioner_b.sub_soal=10 AND detail_penilaian_b.id_pengajar='$id_pengajar'")->row_array();
                          ?>  
                            <td><?= $total2['total']; ?></td>
                          <?php } ?>
                          <!-- akhir loop soal ruang kemampuan -->
                          ...
                          <?php 
                            foreach($memahami_masalah as $s3){
                              ...
                              $total3 = $this->db->query("SELECT SUM(jawaban) as total FROM penilaian_b LEFT JOIN pelatihan ON penilaian_b.kd_pelatihan=pelatihan.kd_pelatihan
                                                                LEFT JOIN kuisioner_b ON penilaian_b.id_soalB=kuisioner_b.id_kuisionerB
                                                                LEFT JOIN detail_penilaian_b ON detail_penilaian_b.id_penilaian_b=penilaian_b.idku
                                                                WHERE penilaian_b.id_soalB='$id_soal3' AND pelatihan.id_program='$program' AND kuisioner_b.jenis_soal=2 AND kuisioner_b.sub_soal=11 AND detail_penilaian_b.id_pengajar='$id_pengajar'")->row_array();
                          ?>  
                            <td><?= $total3['total']; ?></td>
                          <?php } ?>
                          <!-- akhir loop soal memahami_masalah -->
                          ...
                          <?php 
                            foreach($penampilan as $s4){
                              ...
                              $total4 = $this->db->query("SELECT SUM(jawaban) as total FROM penilaian_b LEFT JOIN pelatihan ON penilaian_b.kd_pelatihan=pelatihan.kd_pelatihan
                                                                LEFT JOIN kuisioner_b ON penilaian_b.id_soalB=kuisioner_b.id_kuisionerB
                                                                LEFT JOIN detail_penilaian_b ON detail_penilaian_b.id_penilaian_b=penilaian_b.idku
                                                                WHERE penilaian_b.id_soalB='$id_soal4' AND pelatihan.id_program='$program' AND kuisioner_b.jenis_soal=2 AND kuisioner_b.sub_soal=12 AND detail_penilaian_b.id_pengajar='$id_pengajar'")->row_array();
                          ?>  
                            <td><?= $total4['total']; ?></td>
                          <?php } ?>
                          <td rowspan="5"></td>
