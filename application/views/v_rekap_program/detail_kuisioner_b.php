        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib"><a class="btn btn-info" href="<?= base_url(); ?>rekap_program/in_detail_program/<?= $program; ?>"><span class="icon icon-backward"></span></a> DETAIL KUISIONER B PER PROGRAM : <?= $program; ?></span>
            </h1>
          </div>
          <hr>
          <!--  -->
