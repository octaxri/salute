                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <!-- <tr>
                          ...
                          <td class="text-center"><a class="badge badge-primary" href="<?= base_url();?>rekap_program/rekap_kuisioner_b_unit_kompetensi/<?= $program;?>"><span class="icon icon-eye"></span> Detail</a></td>
                        </tr> -->
                      </tbody>
                    </table>
                    <br>
      ...
      <div class="modal-content">
        ...
        <?php foreach($daftar_pengajar as $i) { ?>
          <div class="form-group">
            <a class="btn btn-primary col-xs-12" href="<?= base_url(); ?>rekap_program/in_detail_pelatihan_pengajar_kuisioner_b/<?= $program; ?>/<?= $i['id_pengajar']; ?>"><?= $i['nama_pengajar'];?></a><br><br>
          </div>
        <?php } ?>
          <hr>
          <div class="form-group">
