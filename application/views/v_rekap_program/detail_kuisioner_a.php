            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/cetak_rekap_program_kuisioner_a/<?= $program; ?>" class="btn btn-danger icon icon-file-pdf-o" target="_blank"> PDF</a> | <a href="<?= base_url();?>laporan/export_excel_rekap_program_kuisioner_a/<?= $program;?>" class="btn btn-success icon icon-file-excel-o"> Excel</a>          
                    </center>
                    <br><br>
