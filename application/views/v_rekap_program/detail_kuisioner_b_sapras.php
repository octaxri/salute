        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib"><a class="btn btn-info" href="<?= base_url(); ?>rekap_program/rekap_kuisioner/2/<?= $program; ?>"><span class="icon icon-backward"></span></a> LAPORAN KUISIONER B - SARANA DAN PRASARANA | PER PROGRAM : <?= $program; ?></span>
            </h1>
          </div>
          <hr>
          <br>
            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/rekap_perprogram_kuisioner_b_sapras/<?= $program; ?>" class="btn btn-danger icon icon-file-pdf-o" target="_blank"> PDF</a> | <a href="<?= base_url(); ?>laporan/export_exel_perprogram_kuisioner_b_sapras/<?= $program; ?>" class="btn btn-success icon icon-file-excel-o"> Excel</a> 
                    </center>
                    <br><br>
