        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib"><a class="btn btn-info" href="<?= base_url(); ?>pelatihan_peserta"><span class="icon icon-backward"></span></a> KUISIONER B | Sarana dan Prasarana</span>
            </h1>
          </div>
          <hr>
          <br>
            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <strong>Daftar Kuisioner B</strong>
                </div>
                <div class="card-body">
                    <!-- ISINYA -->
