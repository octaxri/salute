        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib"><a class="btn btn-info" href="<?= base_url(); ?>rekap_kejuruan/rekap_kuisioner/2/<?= $kejuruan; ?>" ><span class="icon icon-backward"></span></a> LAPORAN KUISIONER B - TENAGA PELATIH | PER KEJURUAN : <?= strtoupper($detail_kejuruan['nama_kejuruan']); ?></span>
            </h1>
          </div>
          <hr>
          <br>
            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/cetak_kejuruan_kuisioner_b_tenaga_pelatih/<?= $kejuruan; ?>/<?= $id_pengajar; ?>" target="_blank" class="btn btn-danger icon icon-file-pdf-o"> PDF</a> | <a href="<?= base_url(); ?>laporan/export_exel_kejuruan_kuisioner_b_sarpras/<?= $kejuruan; ?>" target="_blank" class="btn btn-success icon icon-file-excel-o"> Excel</a>
                    </center>
                    <br><br>
                  ...
                  <div class="table-responsive">
                    ...
                    <br><br><br><br>
                    <center><h3>GRAFIK HASIL ANALISIS ANGKET <br>LAPORAN PER KEJURUAN : <?= strtoupper($detail_kejuruan['nama_kejuruan']); ?>
                    <br>NAMA INSTRUKTUR : <?= strtoupper($pengajar['nama_pengajar']); ?>
                    </h3></center>
