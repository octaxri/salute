            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/cetak_kejuruan_kuisioner_b_tenaga_pelatih/<?= $kejuruan; ?>/<?= $id_pengajar; ?>" target="_blank" class="btn btn-danger icon icon-file-pdf-o"> PDF</a> | <a href="<?= base_url(); ?>laporan/export_exel_kejuruan_kuisioner_b_tenaga_pelatih/<?= $kejuruan; ?>/<?= $id_pengajar; ?>" target="_blank" class="btn btn-success icon icon-file-excel-o"> Excel</a>
                    </center>
                    <br><br>
                    ...
                    <script>
                        ...
                        var chart = new CanvasJS.Chart("chartContainer", {
                            ...
                            title: {
                              ...
                              subtitles:[
                              {
                                text: "LAPORAN PER KEJURUAN : <?= strtoupper($detail_kejuruan['nama_kejuruan']); ?>",
