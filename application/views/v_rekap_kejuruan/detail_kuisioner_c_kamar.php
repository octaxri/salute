            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/cetak_kejuruan_kuisioner_c_kamar/<?= $kejuruan; ?>" target="_blank" class="btn btn-danger icon icon-file-pdf-o"> PDF</a> | <a href="<?= base_url(); ?>laporan/export_excel_kejuruan_kuisioner_c_kamar/<?= $kejuruan; ?>" class="btn btn-success icon icon-file-excel-o" target="_blank"> Excel</a>
                    </center>
                    <br><br>
