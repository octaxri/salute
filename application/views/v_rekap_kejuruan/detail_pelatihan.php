                        ...
                        var chart = new CanvasJS.Chart("chartContainer", {
                            ...
                            data: [{        
                                ...
                                dataPoints: [      
                                    ...
                                    { y: <?= $hasil_kuisioner_b_bahan_latihan; ?>,  label: "BAHAN PELATIHAN" , indexLabel: "<?= $hasil_kuisioner_b_bahan_latihan; ?>", indexLabelFontColor: "black", indexLabelOrientation: "horizontal", indexLabelPlacement: "inside"  },
                                    { y: <?= $hasil_kuisioner_c_rekruitmen; ?>,  label: "REKRUITMEN" , indexLabel: "<?= $hasil_kuisioner_c_rekruitmen; ?>", indexLabelFontColor: "black", indexLabelOrientation: "horizontal", indexLabelPlacement: "inside"  },
                                    { y: <?= $hasil_kuisioner_c_penyambutan; ?>,  label: "PENYAMBUTAN" , indexLabel: "<?= $hasil_kuisioner_c_penyambutan; ?>", indexLabelFontColor: "black", indexLabelOrientation: "horizontal", indexLabelPlacement: "inside" },
                                    { y: <?= $hasil_kuisioner_c_sarpras_asrama; ?>,  label: "SAPRAS ASRAMA" , indexLabel: "<?= $hasil_kuisioner_c_sarpras_asrama; ?>", indexLabelFontColor: "black", indexLabelOrientation: "horizontal", indexLabelPlacement: "inside"  },
                                    { y: <?= $hasil_kuisioner_c_konsumsi; ?>,  label: "KONSUMSI" , indexLabel: "<?= $hasil_kuisioner_c_konsumsi; ?>", indexLabelFontColor: "black", indexLabelOrientation: "horizontal", indexLabelPlacement: "inside"  },
                                    { y: <?= $hasil_kuisioner_c_secara_umum; ?>,  label: "SECARA UMUM" , indexLabel: "<?= $hasil_kuisioner_c_secara_umum; ?>", indexLabelFontColor: "black", indexLabelOrientation: "horizontal", indexLabelPlacement: "inside" },
                                ]
                            }]
                        });
                        chart.render();
