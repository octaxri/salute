        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib"><a class="btn btn-info" href="<?= base_url(); ?>rekap_kejuruan/rekap_kuisioner/2/<?= $kejuruan; ?>"><span class="icon icon-backward"></span></a> LAPORAN KUISIONER B - BAHAN PELATIHAN | PER KEJURUAN : <?= $kejuruan1['nama_kejuruan']; ?></span>
            </h1>
          </div>
          <hr>
          <br>
            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/rekap_kejuruan_kuisioner_b_bahan_pelatihan/<?= $kejuruan; ?>" class="btn btn-danger icon icon-file-pdf-o" target="_blank"> PDF</a> | <a href="<?= base_url(); ?>laporan/export_excel_kejuruan_kuisioner_b_bahan_pelatihan/<?= $kejuruan; ?>" class="btn btn-success icon icon-file-excel-o"> Excel</a> 
                    </center>
                    <br><br>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php $no=1;  
                          foreach($kuisioner_b_bahan_latihan as $ur){
