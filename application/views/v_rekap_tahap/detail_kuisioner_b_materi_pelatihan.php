        ...
        <?php } ?> 
          ...
          <div class="title-bar">
            <h1 class="title-bar-title">
              <span class="d-ib"><a class="btn btn-info" href="<?= base_url(); ?>rekap_tahap/rekap_kuisioner/2/<?= $tahap; ?>"><span class="icon icon-backward"></span></a> LAPORAN KUISIONER B - MATERI PELATIHAN | PER TAHAP : <?= $tahap; ?></span>
            </h1>
          </div>
          <hr>
          <br>
