            ...
            <div class="col-xs-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- IISI -->
                    <center>
                        <a href="<?= base_url(); ?>laporan/cetak_pertahap_kuisioner_b_tenaga_pelatih/<?= $tahap; ?>/<?= $id_pengajar; ?>" target="_blank" class="btn btn-danger icon icon-file-pdf-o"> PDF</a> | <a href="<?= base_url(); ?>laporan/export_exel_pertahap_kuisioner_b_sarpras/<?= $tahap; ?>" class="btn btn-success icon icon-file-excel-o"> Excel</a>
                    </center>
                    <br><br>
                  ...
                  <div class="table-responsive">
                    ...
                    <br><br><br><br>
                    <center><h3>GRAFIK HASIL ANALISIS ANGKET <br>LAPORAN PER TAHAP : <?= $tahap; ?>
